...
def create_flashcards(
    ...
    flashcard_extraction.run(api_key=api_key, delimiter=delimiter)
...
def env_location():
    print(
        ...
        'If the file does not exist, please create it and set your OPENAI_API_KEY and TARGET_LANGUAGE. \n'
